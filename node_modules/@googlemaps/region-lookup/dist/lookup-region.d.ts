...
import type { LanguageRegion, RegionMatch, Request, PaginationData } from "./common";
/**
...
export declare const lookupRegionUrl = "https://regionlookup.googleapis.com/v1alpha:lookupRegion";
/**
 ...
 */
export declare function lookupRegion({ method, headers, data, url, ...config }: LookupRegionRequest, axiosInstance?: AxiosInstance): Promise<LookupRegionResponse>;
