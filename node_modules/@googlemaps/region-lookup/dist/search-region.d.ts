...
import type { LanguageRegion, PaginationData, RegionMatch, Request } from "./common";
/**
...
export interface RegionSearchValue extends LanguageRegion {
     ...
     * Place type to match.
     */
    place_type: "administrative_area_level_1" | "administrative_area_level_2" | "administrative_area_level_3" | "administrative_area_level_4" | "country" | "locality" | "sublocality_level_1" | "neighborhood" | "postal_code";
    /**
...
export declare const searchRegionUrl = "https://regionlookup.googleapis.com/v1alpha:searchRegion";
/**
 ...
 */
export declare function searchRegion({ method, headers, data, url, ...config }: SearchRegionRequest, axiosInstance?: AxiosInstance): Promise<SearchRegionResponse>;
